...
| Area | Cadence Virtuoso Behavior | Lumen Status | Next Work |
| --- | --- | --- | --- |
...
| Top-level pins | Pins are first-class ports used by symbols and netlisting | Implemented as Cadence-style terminal objects with direction, usage, orientation, marker, stub, and label | Add richer batch pin placement templates |
...
## Lumen Improvements Beyond Virtuoso
